...
public:
  ...
  virtual vector<su2double> GetThicknessVector(su2double *Plane_Normal, vector<su2double> &Xcoord_Airfoil, vector<su2double> &Ycoord_Airfoil, vector<su2double> &Zcoord_Airfoil, vector<su2double> &Xcoord, vector<su2double> &Xcoord_Airfoil_, vector<su2double> &X_for_z, vector<su2double> &z1, vector<su2double> &z2);
...
void UpdateTurboVertex(CConfig *config,unsigned short val_iZone, unsigned short marker_flag);
  ...
  vector<su2double> GetThicknessVector(su2double *Plane_Normal, vector<su2double> &Xcoord_Airfoil, vector<su2double> &Ycoord_Airfoil, vector<su2double> &Zcoord_Airfoil, vector<su2double> &Xcoord, vector<su2double> &Xcoord_Airfoil_, vector<su2double> &X_for_z, vector<su2double> &z1, vector<su2double> &z2);
